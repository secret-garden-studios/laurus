...
export function image300(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "public/material-ui/thin/image_24dp_E3E3E3_FILL0_wght300_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
...
export function image400(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "public/material-ui/image_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
...
export function polyline300(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "public/material-ui/thin/polyline_24dp_E3E3E3_FILL0_wght300_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
...
export function skew200(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "/skew_24dp_E3E3E3_FILL0_wght200_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
    ...
    stroke_width: 0,
    markup: base64Encode(
      `<path d="M 169.37155,-263.47771 70.628445,-823.47771 790.62845,-696.52229 889.37155,-136.52229 Z M 202.31848,-296.42463 842.31848,-183.57537 757.68152,-663.57537 117.68152,-776.42463 Z M 202.31848,-296.42463 117.68152,-776.42463 Z"/>`,
    ),
  };
}

export function skew300(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "/skew_24dp_E3E3E3_FILL0_wght300_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
    ...
    stroke_width: 0,
    markup: base64Encode(
      `<path d="M 152.89809,-247.00425 47.101906,-847.00425 807.10191,-712.99575 912.89809,-112.99575 Z M 202.31848,-296.42463 842.31848,-183.57537 757.68152,-663.57537 117.68152,-776.42463 Z M 202.31848,-296.42463 117.68152,-776.42463 Z"/>`,
    ),
  };
}
...
export function inkPen300(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "/material-ui/thin/ink_pen_24dp_E3E3E3_FILL1_wght300_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
...
export function antigravity200(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "public/material-ui/thin/antigravity_24dp_E3E3E3_FILL0_wght200_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
    ...
    stroke_width: 0,
    markup: base64Encode(
      `<path d="M480.23-839.23q69.46-.77 107.27 52.15 37.81 52.93 65.96 119.39 24.46 58.38 48.46 131.54 24 73.15 50.23 147.3 26 71.16 55.47 133.7 29.46 62.53 68.15 105.69 4.92 5.92 4.69 12.92-.23 7-5.15 11.39-5.69 5.15-12.46 5.38-6.77.23-12.39-4.69-69.77-65.08-117.31-137.35-47.53-72.27-91.84-120.81-34-38-72.89-60.38-38.88-22.38-88.19-21.62-49.31-.76-88.19 21.62-38.89 22.38-72.89 60.38-44.3 48.54-91.84 120.81Q179.77-189.54 110-124.46q-5.62 4.92-12.38 4.69-6.77-.23-12.47-5.38-4.92-4.39-5.15-11.39-.23-7 4.69-12.92 38.69-42.39 68.16-105.31 29.46-62.92 55.46-134.08 26.23-74.15 50.23-147.3 24-73.16 48.46-131.54 28.15-66.46 65.96-119.39 37.81-52.92 107.27-52.15Zm-81.38 84q-29.47 44-51 93.69-33.7 79.08-60.35 165.12-26.65 86.03-60.88 171.03 20.76-27.15 41.19-53.92 20.42-26.77 43.5-50.54 36.61-35.15 77.34-54.96 40.73-19.81 91.58-19.81t91.58 19.81q40.73 19.81 77.34 54.96 23.08 23.77 43.5 50.54 20.43 26.77 41.2 53.92-34.23-85-60.89-171.03-26.65-86.04-60.34-165.12-21.54-49.69-51-93.69-29.47-44-81.39-44t-81.38 44Zm81.38 250.61Z"/>`,
    ),
  };
}

export function antigravity300(
  fill: string = "rgba(227, 227, 227, 1)",
  width: number = 24,
  height: number = 24,
): LaurusClientSvg {
  return {
    media_key: "public/material-ui/thin/antigravity_24dp_E3E3E3_FILL0_wght300_GRAD0_opsz24.svg",
    width,
    height,
    viewbox: "0 -960 960 960",
    fill,
    ...
    stroke_width: 0,
    markup: base64Encode(
      `<path d="M480.62-859.61q75.23-.39 116.88 56.57 41.65 56.96 71.73 129.19 25.23 60.7 49.23 135.77 24 75.08 50.62 151.16 26 73.07 56.23 137.34 30.23 64.27 70.07 109.35 6.46 7.46 5.85 16.96-.62 9.5-7.08 16.19-6.84 7.08-15.73 7.69-8.88.62-17.19-5.84-74.38-63.54-123.65-137.93-49.27-74.38-97.43-127.15-34-38-72.69-60.19-38.69-22.19-86.84-21.81-48.16-.38-86.85 21.81-38.69 22.19-72.69 60.19-48.16 52.77-97.43 127.15Q174.39-168.77 100-105.23q-8.31 6.46-17.19 5.84-8.89-.61-15.73-7.69-6.46-6.69-7.08-16.19-.61-9.5 5.85-16.96 39.84-44.69 70.07-109.16 30.24-64.46 56.24-137.53 26.61-76.08 50.61-151.16 24-75.07 49.23-135.77 30.08-72.23 71.73-129.19 41.66-56.96 116.89-56.57Zm-76.2 101.49q-27.73 41.51-48.5 87.35-29.84 67.54-53.42 142.81-23.58 75.27-53.19 155.27 20.38-24.08 39.84-45.46 19.46-21.39 41-39.77 34.31-27.08 70.43-40.73 36.11-13.66 80.04-13.66 43.92 0 80.03 13.66 36.12 13.65 70.43 40.73 21.54 18.38 41 39.77 19.46 21.38 39.84 45.46-29.61-80-53.19-155.27-23.58-75.27-53.42-142.81-20.77-45.84-48.5-87.35-27.73-41.5-76.19-41.5-48.47 0-76.2 41.5Zm76.2 245.81Z"/>`,
    ),
  };
}
