...
export default async function Home({ searchParams }: { searchParams: Promise<{ logout?: string, reset_password?: string }> }) {
  const { logout, reset_password } = await searchParams;
